        ...
        <div className="row">
          ...
          <Slide right duration={1000}>
            <aside className="four columns footer-widgets">
              ...
              <div className="widget widget_tweets">
                  <h4 className="widget-title">Outsourcing and Finding Talents</h4>
                  <p>
                    We offer outsourcing services that provide access to top talents and expertise for your software projects.
                  </p>
                  <p>
                    We excel in sourcing skilled developers, designers, and engineers from our extensive talent pool. Our team has the expertise and experience to deliver successful projects, and we prioritize effective communication and collaboration throughout the process.
                  </p>
                  <p>
                    Contact us today to discuss your outsourcing or staffing needs and leverage our talented professionals for exceptional software solutions.
                  </p>
              </div>
            </aside>
          </Slide>
